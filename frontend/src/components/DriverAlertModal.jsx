...
export const DriverAlertModal = ({ isOpen, onClose, vehicle }) => {
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content" style={{ maxWidth: '420px', background: '#1e293b', border: '1px solid #334155', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.5)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', borderBottom: '1px solid #334155', paddingBottom: '12px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Smartphone color="#38bdf8" size={20} />
            <h3 style={{ fontSize: '1rem', color: '#f8fafc', fontWeight: 700, margin: 0 }}>Driver Mobile Dispatch Card</h3>
          </div>
        ...
        <div style={{ background: '#0f172a', border: '1px solid #334155', borderRadius: '12px', padding: '16px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.72rem', color: '#94a3b8', fontWeight: 600, marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            <span>📱 Emergency Logistics SMS</span>
            <span>Just Now</span>
          </div>

          <div style={{ background: 'rgba(239, 68, 68, 0.15)', borderLeft: '4px solid #ef4444', border: '1px solid rgba(239, 68, 68, 0.3)', padding: '12px', borderRadius: '8px', marginBottom: '12px' }}>
          ...
          <div style={{ background: 'rgba(16, 185, 129, 0.15)', borderLeft: '4px solid #10b981', border: '1px solid rgba(16, 185, 129, 0.3)', padding: '12px', borderRadius: '8px' }}>
